...
public class MessageTransaction extends Transaction {
	...
	public MessageTransaction(PublicKeyAccount creator, Account recipient, BigDecimal amount, BigDecimal fee, byte[] data, byte[] isText, byte[] encrypted, long timestamp, byte[] reference, byte[] signature) {
	...
	public static Transaction Parse(byte[] data) throws Exception
	{
		...
		return new MessageTransaction(creator, recipient, amount, fee, arbitraryData, isTextByte, encryptedByte, timestamp, reference, signatureBytes);
